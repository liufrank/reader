...
module.exports = evt;
},{"./js":7,"./keen":8,"underscore":21}],5:[function(require,module,exports){
var sq = require('./sq'),
    evt = require('./evt'),
    dom = require('./dom'),
    js = require('./js'),
...
keen.always({
  'href': sq.parentHref,
  'hostname': sq.parentHost,
  'referrer': sq.parentReferrer,
  'referrerHost': sq.parentReferrerHost,
  'userId': sq.userId
});
...
var events = {
  ...
  'squirt.carousel.end': function(e){
    ...
    if(sq.onboarding){
      evt.dispatch('squirt.redirect', {'href': '/install.html'});
    } else {
      dom.hide('.carousel');
      dom.show('.reader-content');
      // if(!userSettings.get('email.submitted')){
      //   dom.hide('.tweet-preview');
      //   dom.show('.feature-requests');
      // }
    }
  }
...
},{"./cross-frame-events":2,"./dom":3,"./evt":4,"./js":7,"./keen":8,"./reader":11,"./sq":14,"./user-settings":16,"underscore":21}],6:[function(require,module,exports){
var evt = require('./evt'),
    dom = require('./dom'),
    _ = require('underscore');
...
var Keen = (function init(){
  ...
  e.type="text/javascript",e.async=!0,e.src="//web.archive.org/web/20180625213541/http://dc8na2hxrj29i.cloudfront.net/code/keen-2.1.0-min.js";
...
},{"./carousel":1,"./dom":3,"./evt":4,"./gui":6,"./js":7,"./keen":8,"./word":17,"q":20,"underscore":21}],12:[function(require,module,exports){
var dom = require('./dom'),
    evt = require('./evt'),
    sq = require('./sq');
...
}).call(this,require("/Users/cam/src/squirt.io/client/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js"))
},{"/Users/cam/src/squirt.io/client/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":19}],21:[function(require,module,exports){
//     Underscore.js 1.6.0
...
/*
     FILE ARCHIVED ON 21:35:41 Jun 25, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 00:11:59 Apr 21, 2020.
...
playback timings (ms):
  ...
  load_resource: 219.435
  exclusion.robots: 0.15
  PetaboxLoader3.datanode: 56.297 (4)
  LoadShardBlock: 223.555 (3)
  CDXLines.iter: 13.22 (3)
  RedisCDXSource: 83.863
  esindex: 0.015
  exclusion.robots.policy: 0.14
  PetaboxLoader3.resolve: 382.849 (2)
*/
...
var evt = {
  ...
  dispatch: function(evtStr, attrs, dispatcher){
    ...
    if((!attrs || !attrs.notForKeen) && evtStr.match('squirt\.[^.]+$')) {
      keen.addEvent(evtStr.replace('squirt\.', ''), attrs);
    }
...
module.exports = evt;
},{"./js":5,"./keen":7,"underscore":13}],4:[function(require,module,exports){
...
!function initSquirt(){
  ...
  keen.always({ userId: sq.iframeQueryParams.userId });
  ...
  _.extend(sq.iframeQueryParams, {
    ...
    parentReferrerHost: keen.globalProps.referrerHost,
    onboarding: sq.demoText ? true : ''
  });

  var iframeSrc = window.location.protocol +
    sq.iframeQueryParams.host +
    'https://raw.githubusercontent.com/liufrank/reader/master/iframe.html?' +
...
function reinstall(){
  var reinstallHtml = "<div class=\"sq-reinstall-wrapper\">\n  <!-- these styles are here and not in parent-frame.css to\n       decouple them from the\n    -->\n  <style>\n    * {\n      border: 0;\n      margin: 0;\n      padding: 0;\n      font-weight: inherit;\n      font-size: inherit;\n      color: inherit;\n      text-decoration: inherit;\n    }\n\n    .sq-reinstall {\n      font-family: Georgia, serif;\n      position: fixed;\n      width: 100%;\n      height: 100%;\n      top: 0;\n      left: 0;\n      background-color: white;\n      text-align: center;\n      padding-top: 3em;\n      position: absolute;\n      z-index: 9999999999999999999999999;\n    }\n\n    h1, h2, h3, h4, p{\n      font-size: 18px;\n      font-family: Georgia;\n      color: #222;\n      margin: 1.2em 1em 1.4em 1em;\n      border: 0;\n    }\n\n    h2 {\n      font-size: 2.5em;\n    }\n\n    h3 {\n      font-size: 2em;\n    }\n\n    h4 {\n      font-size: 1.3em;\n      color: #555;\n    }\n\n    a, a:visited, a:hover, a:link {\n       color: #2FA1EE;\n    }\n\n    .sq-logo {\n      width: 90px;\n      height: 90px;\n    }\n\n    .favicon-logo {\n      width: 16px;\n      height: 16px;\n      position:relative;\n    }\n\n    .sq-close-reinstall {\n      color: #999 !important;\n      font-size: 1.2em;\n      display: block;\n      margin-top: 1.2em;\n    }\n  </style>\n  <div class=\"sq-reinstall\">\n    <img class='sq-logo' src='//web.archive.org/web/20191012060153/http://squirt.io/images/logo.png'/>\n    <h2>Your bookmarklet is smelling a little fishy...</h2>\n    <h3>Drag this fresh one to your bookmarks bar: <a class=\"sq-bm\" href=\"javascript:(function(){sq=window.sq=window.sq||{};if(sq.script){sq.again();}else{sq.bookmarkletVersion='0.3.0';sq.iframeQueryParams={host:'//web.archive.org/web/20191012060153/http://squirt.io',userId:'--squirtUser--',};sq.script=document.createElement('script');sq.script.src=sq.iframeQueryParams.host+'/bookmarklet/frame.outer.js';document.body.appendChild(sq.script);}})();\">Squirt</a></h3>\n    <h4>Need help? Visit the <a href='https://web.archive.org/web/20191012060153/http://squirt.io/install.html'>install page</a></h4>\n    <h4><a href=\"http://squirt.io/change-log.html\">What's new</a></h4>\n    <a class=\"sq-close-reinstall\" href=\"\">Back</a>\n  </div>\n</div>\n"
                      .replace('--squirtUser--', sq.userId);

  keen.addEvent('reinstall',
    {fromVersion: sq && sq.bookmarkletVersion,
    toVersion: sq.pageScriptVersion});
...
},{"./cross-frame-events":1,"./dom":2,"./evt":3,"./js":5,"./just-the-facts":6,"./keen":7,"./loading":8,"fs":9,"underscore":13}],5:[function(require,module,exports){
...
var Keen = (function init(){
  ...
  e.type="text/javascript",e.async=!0,e.src="//web.archive.org/web/20191012060153/http://dc8na2hxrj29i.cloudfront.net/code/keen-2.1.0-min.js";
...
/*
     FILE ARCHIVED ON 06:01:53 Oct 12, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 23:00:09 Apr 20, 2020.
...
/*
playback timings (ms):
  captures_list: 412.816
  LoadShardBlock: 196.114 (3)
  CDXLines.iter: 12.086 (3)
  exclusion.robots: 0.194
  exclusion.robots.policy: 0.18
  esindex: 0.012
  RedisCDXSource: 201.568
  PetaboxLoader3.resolve: 87.596 (2)
  PetaboxLoader3.datanode: 143.722 (4)
  load_resource: 43.601
*/